...
public class TeatroColonGUI extends JFrame {
    ...
    private JMenuItem salvar, abrir, exportar, importar, salir, nuevo, cerrar;
    private JMenu menu;	
    ...
    private void elementos() throws Exception {
     ...
     /**
       * prepara los elementos que va contener el menu de TeatroColonGUI
       */
    ...
    /**
     *  crea las acciones de los botones del menu
     */
    ...
    private void accionSalvar() {
    	...
    	int confirmacion= fileChooser.showSaveDialog(this);
    	try {
    		if(confirmacion== fileChooser.APPROVE_OPTION) {
    			teatro.salvar01(fileChooser.getSelectedFile());
    		}
    ...
    private void accionAbrir() {
    	...
    	try {
    		if(confirmado== fileChooser.APPROVE_OPTION) {
    			teatro.abrir01(fileChooser.getSelectedFile());
    			actualice();
    		}
    	}catch(TeatroColonException e) {
    		JOptionPane.showMessageDialog(this,e.getMessage());
    ...
    private void accionImportar() {
    	...
    	try {
    		if(confirmado==fileChooser.APPROVE_OPTION) {
    			Teatro teatroFile = teatro.importar03(fileChooser.getSelectedFile());
    			teatro.cambieTeatro(teatroFile);
    			actualice();
    		}
    	}catch(TeatroColonException e) {
    		JOptionPane.showMessageDialog(this,e.getMessage());
    ...
    private void accionExportar() {
    	...
    	try {
    		if(confirmado==fileChooser.APPROVE_OPTION) {
    			teatro.exportar03(fileChooser.getSelectedFile());
    		}
    	}catch(TeatroColonException e) {
    		JOptionPane.showMessageDialog(this,e.getMessage());
    	}
