   ...
   /**
        ...
        busquedaTexto.getDocument().addDocumentListener(new DocumentListener(){
            public void changedUpdate(DocumentEvent ev){
                try{
                    ...
                    JOptionPane.showMessageDialog(null,"un error ha ocurrido y el programa debe cerrarse","Whoops! something broke",1);
                    Registro.registre(e);
                    System.exit(0);
                }
            }
    ...
    private void  accionAdicionar(){
        try{
            ...
            JOptionPane.showMessageDialog(null,"Valor de los creditos invalido","ERRROR",JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void accionBuscar(){
        ...
        if(patronBusqueda.length() > 0) {
            ...
            for(int i = 0; i < results.size(); i++) {
                buffer.append(results.get(i).getId());//cambio de toString de Actividad al getId de actividad
                buffer.append('\n');
                buffer.append('\n');
             }
        }
